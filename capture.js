...
(function () {
  ...
  function buildOverlay() {
    ...
    root.innerHTML = [
      '<style>',
      // 白色主题:与侧边栏/设置页同一套令牌(见 docs/UI-SPEC.md)
      '.panel{width:min(560px,86%);background:#fff;color:#1F2329;border-radius:10px;',
      ...
      '.ts{color:#E6485D;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:600;',
      'background:rgba(230,72,93,.10);padding:1px 6px;border-radius:5px}',
      '.x{background:transparent;border:none;color:#9AA1AB;font-size:18px;padding:0 2px;',
      'line-height:1;cursor:pointer;margin-left:10px}',
      '.x:hover{color:#1F2329}',
      '.quote{margin:0 0 10px;padding:8px 10px;border-left:3px solid #E6485D;',
      'background:#F7F7F5;border-radius:0 6px 6px 0;color:#6E7580;font-size:13px}',
      '.quote .zh{display:block;color:#1F2329}',
      '.quote .en{display:block;color:#9AA1AB;font-size:12px;margin-top:2px}',
      'textarea{width:100%;box-sizing:border-box;min-height:72px;resize:vertical;',
      'background:#fff;border:1px solid #D8D8D4;',
      'border-radius:6px;color:#1F2329;padding:8px 10px;font:inherit;outline:none}',
      'textarea::placeholder{color:#9AA1AB}',
      'textarea:focus{border-color:#E6485D}',
      '.thumb{display:none;margin-top:8px;max-height:120px;border-radius:6px;',
      'border:1px solid #E9E9E6;cursor:zoom-in}',
      '.shotbar{display:none;gap:8px;margin-top:6px}',
      '.shotbar button{background:#F0F0EE;color:#1F2329;padding:4px 12px;font-size:12px}',
      '.shotbar button:hover{background:#E9E9E6}',
      ...
      '.shot{background:#F0F0EE;color:#1F2329}',
      '.shot:hover{background:#E9E9E6}',
      '.save{background:#E6485D;color:#fff;font-weight:600;margin-left:auto}',
      '.save:hover{background:#D63D52}',
      '.hint{color:#9AA1AB;font-size:12px}',
      '.err{color:#D9304E;font-size:12px;display:none}',
      '</style>',
      '<div class="panel">',
